...
--    AND EXISTS (SELECT * FROM SHATCKN WHERE SFRSTCR_PIDM = SPRIDEN_PIDM AND SFRSTCR_TERM_CODE = :select_term_code.STVTERM_CODE AND SFRSTCR_RSTS_CODE IN (SELECT STVRSTS_CODE FROM STVRSTS) AND SGBSTDN_LEVL_CODE = 'UG' AND SFRSTCR_GRDE_CODE = 'I' HAVING COUNT(*)>2)
      -- STUDENT CONDITIONS
